...
@router.get("/")
def get_places_for_category(category: str, lat: float, lon: float):
    url = f"https://search-maps.yandex.ru/v1/?apikey={key}&text={category}&lang=ru_RU&results=5&ll={lat}, {lon}"
